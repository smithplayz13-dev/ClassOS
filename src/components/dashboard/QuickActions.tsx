...
export function QuickActions() {
  ...
  const actions = [
    { id: "assignment", label: "Add assignment", sub: "Due date • Priority", icon: "＋", accent: "bg-violet-500" },
    { id: "test", label: "Add test", sub: "Subject • Date", icon: "◑", accent: "bg-sky-500" },
    { id: "timetable", label: "View timetable", sub: "Week overview", icon: "▦", accent: "bg-zinc-600" },
    { id: "missed", label: "I Missed School", sub: "Catch-up flow", icon: "↺", accent: "bg-amber-500" },
  ] as const;
